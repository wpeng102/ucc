...
static ucc_config_field_t ucc_tl_dpu_lib_config_table[] = {
    {"", "", NULL, ucc_offsetof(ucc_tl_dpu_lib_config_t, super),
     UCC_CONFIG_TYPE_TABLE(ucc_tl_lib_config_table)},

    {NULL}};

static ucs_config_field_t ucc_tl_dpu_context_config_table[] = {
    {"", "", NULL, ucc_offsetof(ucc_tl_dpu_context_config_t, super),
    ...
    {"PIPELINE_BLOCK_SIZE", "1M",
     "DPU Pipeline Block Size",
     ucc_offsetof(ucc_tl_dpu_context_config_t, pipeline_buffer_size),
     UCC_CONFIG_TYPE_MEMUNITS
    },

    {"PIPELINE_BUFFERS", "2",
     "DPU Pipeline Number of Blocks",
     ucc_offsetof(ucc_tl_dpu_context_config_t, pipeline_num_buffers),
